<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
    <div class="max-w-md mx-auto">
      ...
      <!-- Scanner Container -->
      <div class="bg-white p-3 dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
        <!-- Camera Preview -->
        ...
        <div class="p-4">
          <!-- Instruction Text -->
          <p class=" text-center m-2 text-sm bg-opacity-50 rounded py-1">
          ...
          <div class="flex space-x-3 mb-4">
            <button @click="toggleCamera"
              ...
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path v-if="!cameraActive" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <button @click="toggleFlash" v-if="hasFlash && cameraActive"
              ...
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path v-if="!flashOn" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M13 10V3L4 14h7v7l9-11h-7z" />
                <path v-else stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M13 10V3L4 14h7v7l9-11h-7zM15 7h5m0 0v5" />
              </svg>
            </button>
          </div>
          ...
          <div class="mb-4">
            ...
            <div class="space-x-2 justify-self-center text-center xs:flex xs:mb-2">
              <input v-model="manualInput" type="text" placeholder="Masukkan ticket number"
                class="flex-1 w-auto px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                @keypress.enter="processManualInput" />
              <button @click="processManualInput"
                class="px-4 mt-2 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200"
      ...
      <div v-if="recentScans.length > 0" class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
        ...
        <div class="space-y-3">
          <div v-for="scan in recentScans" :key="scan.ticket_number + scan.timestamp"
    ...
    <div v-if="showSuccessModal"
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-sm w-full mx-auto text-center" @click.stop>
        <div
