          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-xs border border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ filteredTickets.length }}</p>
              </div>
            </div>
          </div>
          <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-xs border border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-white">
                  {{ filteredTickets.filter(t => t.is_scanned).length }}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-xs border border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-white">
                  Rp {{ formatCurrency(totalDonation) }}
                </p>
              </div>
            </div>
          </div>
