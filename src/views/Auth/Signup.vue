...
const handleSubmit = async () => {
  ...
  if (!agreeToTerms.value) {
    errorMessage.value = 'Anda harus menyetujui Terms and Conditions.'
    return
  }
  ...
  try {
    ...
    errorMessage.value = err?.message ?? 'Terjadi kesalahan saat mendaftar. Periksa console & network tab.'
  } finally {
    loading.value = false
  }
}
